...
import { AttachedFiles } from "./projectsetup/AttachedFiles";
import { ExternalUrls } from "./projectsetup/ExternalUrls";
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="ProjectDetails" element={<ProjectDetails />}>
            ...
            <Route
              path="BakerConfiguration"
              element={<BakerConfiguration />}
            ></Route>
            ...
            <Route path="MyBaker" element={<MyBaker />}>
              <Route index element={<AttachedFiles />}></Route>
              <Route path="ExternalUrls" element={<ExternalUrls />}></Route>
            </Route>
